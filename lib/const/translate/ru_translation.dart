const russianLanguage = {
  ...
  "html": {
    ...
    "nav": ["Настройки", "Файлы", "Кусочки"],
    "main-fab-btn": ["Свойства", "Управление", "Объекты", "Данные", "Старт"],
    "files-fab": ["Аудио", "Рисовать", "Файлы", "URL"],
    ...
    "message": {
      ...
      "notRecomended": [
        ...
        "Большие изображения и музыка будут обрабатываться долго"
      ],
      "alreadyIncledes": [
        "УЖЕ СУЩЕСТВУЕТ",
        "Начинается с числа",
    ...
    "elements": [
      ...
      },
      {
        ...
        "textInWhere":
            "myName: x: myX, y: myY, радиус: myR, начальныйУгол(радиан): myS, конечныйУгол(радиан): myE, часоваяПерегоротка: myCl, цвет: myColor, направление: myDir"
      },
      {
      ...
      {
        "text": ["Начало нажатия", "Конец нажатия"],
        "textInWhere":
            "Начало нажатия нажатыйОбъект://Object <span style='font-size:10px;'>(необязательно)</span>"
      },
      {
        "text": ["Пустый список //a"],
      },
      {
        "text": ["Воспроизвести MyAudio"],
        "textInWhere": "Воспроизвести MyAudio, время начала: StartTime"
      },
      {
        "text": ["Остановить MyAudio"],
      },
      {
        "text": ["Громкость MyAudio 50%"],
      },
      {
        "text": ["Отключить звук MyAudio true"]
      },
      {
